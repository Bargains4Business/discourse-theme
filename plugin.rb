...
# original Sitepoint authors: Jude Aakjaer, Jamison Bjorkman, Kelle-Lee Connolly

# Upstream version (from Sitepoint) that this theme is based on (change this with each update):
# 91ad7d9aee1f03af522270dccd507e4b4cc10f3f
...
after_initialize do
  ...
  module BikeRoarDesign
    class Engine < ::Rails::Engine
      engine_name "bikeroar_design"
      isolate_namespace BikeRoarDesign
    end
  ...
  header = <<-EOS.strip_heredoc.chomp
    <noscript>
      ...
      <a href="http://www.bikeroar.com/products">Products</a>
  ...
  if User.exists?
    bikeroar_site_customization = SiteCustomization.find_or_create_by({
      name: "BikeRoar Crawler links",
      header: header,
...
register_asset "stylesheets/bikeroar/typography.scss"
...
register_custom_html(extraNavItem: "<li id='faq-menu-item'><a href='http://www.bikeroar.com'>BikeRoar Home</a></li>")
